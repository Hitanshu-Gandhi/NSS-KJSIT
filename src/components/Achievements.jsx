  ...
  return (
    <>
      ...
      <div className="md:p-8 rounded-lg">
        <h1 className="uppercase text-center text-3xl md:text-4xl font-[sans-serif] font-bold p-2 m-2 md:mb-8">
          Achievements
        </h1>
        <div className="md:ml-6 p-4">
          <h2 className="md:text-3xl mb-5 font-[sans-serif] text-red-600">
        ...
        <div className="ml-6">
          <h2 className="md:text-3xl mb-5 font-[sans-serif] text-purple-700">
